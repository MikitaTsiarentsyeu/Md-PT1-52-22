...
while True:
   x = int(input("Чтобы узнать текущее время, нажмите 1. Чтобы ввести время с клавиатуры, нажмите 2.\n"))
   if x == 1:
     ...
     if c[0].isdigit() and c[1].isdigit():
        ...
        if len(c[0]) == 2 and len(c[1]) == 2: 
            ...
            print("Введенное время не должно включать символы помимо цифр и двоеточия.")
            continue
   else:
