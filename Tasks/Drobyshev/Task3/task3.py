...
number_list_2     = ["одна", "две", "двадцать одна", "двадцать две", "тридцать одна", "тридцать две", "сорок одна", "сорок две"]
...
if (enter_time == '1'):
    ...
    if mm == 0:        
        ...
        if mm == 1 or mm == 21:
            if hh >= 12 and hh <= 23:
                print (number_list_2[mm-1].capitalize(), "минута", number_list_chisl[hh-12])
            else:
                print (number_list_2[mm-1].capitalize(), "минута", number_list_chisl[hh])
        elif mm == 2 or mm == 22:
            if hh >= 12 and hh <= 23:
    ...
    hh = int(input('Введите время, часы:\n'))
    mm = int(input('Введите время, минуты:\n'))
